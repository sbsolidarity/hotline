...
module.exports = function sms (req, res) {
  ...
  client.sendMessage({
    ...
    body: 'Thank you for contacting SB Solidarity. One of our members will be in touch with you as soon as they are available. If this is an emergency, consider calling 911.'
  }, (err, _result) => {
    if (err) {
      log.error(err)
