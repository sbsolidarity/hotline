...
module.exports = function voice (req, res) {
  ...
  const twiml = '<?xml version="1.0" encoding="UTF-8"?>' +
    '<Response>' +
      '<Say voice="alice" language="es-MX">' +
        LANG.voice.welcome.esp[0] +
      '</Say>' +
      '<Say voice="alice" language="en-US">' +
        LANG.voice.welcome.eng[0] +
      '</Say>' +
      '<Say voice="alice" language="es-MX">' +
        LANG.voice.welcome.esp[1] +
      '</Say>' +
      '<Say voice="alice" language="en-US">' +
        LANG.voice.welcome.eng[1] +
      '</Say>' +
      '<Say voice="alice" language="es-MX">' +
        LANG.voice.welcome.esp[2] +
      '</Say>' +
      '<Say voice="alice" language="en-US">' +
        LANG.voice.welcome.eng[2] +
      '</Say>' +
  ...
  log.info(`Receiving call from ${req.body.From}`)
